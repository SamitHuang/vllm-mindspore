...
from typing import List, Tuple, Iterable, Mapping, Optional, Union, Dict
...
def _flatten_embeddings(embeddings: NestedTensors) -> ms.Tensor:
    ...
    return mint.cat(tuple(_flatten_embeddings(t) for t in embeddings))
