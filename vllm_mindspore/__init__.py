...
from vllm_mindspore.model_executor.layers.rotary_embedding import MRotaryEmbedding
vllm.model_executor.layers.rotary_embedding.MRotaryEmbedding.get_input_positions = MRotaryEmbedding.get_input_positions
